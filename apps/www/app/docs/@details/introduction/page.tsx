    ...
    <div className="pb-20 space-y-10 px-20 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg leading-7">
          ...
          your specific needs or require one that isn't included in the library.
          Often, you end up wrapping library hooks, writing workarounds, or
          mixing hooks from different libraries with incompatible APIs.
        </p>
        <p className="text-lg leading-7">
      ...
      <section className="space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground">
            useHooks.io hands you the actual hook code. You have full control to
            customize and extend the hooks to your needs.
          </p>
        </div>
      ...
      <section className="space-y-6">
        ...
        <Callout>
          <p className="text-sm">
            <strong>Note:</strong> The CLI is inspired by shadcn/ui's component
            workflow, making it easy to add and manage hooks in your React
            applications.
          </p>
        </Callout>
      </section>
